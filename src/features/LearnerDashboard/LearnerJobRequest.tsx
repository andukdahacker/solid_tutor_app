...
interface ILearnerJobRequestProps {
  job: Job;
}

const LearnerJobRequest = (props: ILearnerJobRequestProps) => {
  const latestUpdate =
  ...
  return (
    <>
      <div class="bg-base card w-80 min-w-80 shadow-md">
        <div class="card-body">
...
export default LearnerJobRequest;
